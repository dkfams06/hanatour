  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[95vh] overflow-hidden flex flex-col">
        ...
        {/* 약관 내용 영역 - 모바일에서 높이 강제 제한 */}
        <div className="flex-1 min-h-0">
          <ScrollArea className="h-[40vh] pr-4">
            <div className="space-y-3 md:space-y-4">
              {/* 회원가입약관 */}
              <section>
                <h3 className="text-sm md:text-base font-semibold mb-2">회원가입약관</h3>
                <div className="space-y-2 text-xs md:text-sm text-gray-700 leading-relaxed">
                  {!showFullTerms ? (
                    // 매우 축약된 약관 내용
                    <div className="space-y-2">
                      <div>
                        <h4 className="font-semibold mb-1 text-xs">제1조(목적)</h4>
                        <p className="text-xs">이 약관은 "투어"가 제공하는 인터넷 관련 서비스의 이용과 관련하여 "투어"와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
                      </div>
                      
                      <div>
                        <h4 className="font-semibold mb-1 text-xs">제2조(정의)</h4>
                        <p className="text-xs">"투어"란 엔젤투어(주)가 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말합니다.</p>
                      </div>

                      <div>
                        <h4 className="font-semibold mb-1 text-xs">제3조(약관 등의 명시와 설명 및 개정)</h4>
                        <p className="text-xs">"투어"는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소, 전화번호, 전자우편주소 등을 이용자가 쉽게 알 수 있도록 사이버몰의 초기 서비스화면에 게시합니다.</p>
                      </div>

                      <div>
                        <h4 className="font-semibold mb-1 text-xs">제4조(서비스의 제공 및 변경)</h4>
                        <p className="text-xs">"투어"는 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결, 구매계약이 체결된 재화 또는 용역의 배송 등의 업무를 수행합니다.</p>
                      </div>
                    ...
                    <>
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">제1조(목적)</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">제2조(정의)</h4>
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">제3조(약관 등의 명시와 설명 및 개정)</h4>
                        <div className="space-y-1 md:space-y-2">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">제4조(서비스의 제공 및 변경)</h4>
                        <div className="space-y-1 md:space-y-2">
              ...
              {/* 개인정보처리방침 */}
              <section>
                <h3 className="text-sm md:text-base font-semibold mb-2">개인정보처리방침안내</h3>
                <div className="space-y-2 text-xs md:text-sm text-gray-700 leading-relaxed">
                  {!showFullTerms ? (
                    // 매우 축약된 개인정보처리방침
                    <div className="space-y-2">
                      <p className="text-xs">
                        엔젤투어(주)는 이용자의 개인정보를 중요시하며, 「개인정보 보호법」을 준수하고 있습니다. 
                        회사는 개인정보처리방침을 통하여 이용자가 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 
                        개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
                      </p>

                      <div>
                        <h4 className="font-semibold mb-1 text-xs">1. 수집하는 개인정보 항목</h4>
                        <p className="text-xs"><strong>필수 정보:</strong> 이름, 아이디, 비밀번호, 이메일</p>
                      </div>

                      <div>
                        <h4 className="font-semibold mb-1 text-xs">2. 개인정보의 수집 및 이용목적</h4>
                        <p className="text-xs">회원가입 및 관리, 서비스 제공 및 운영, 고객상담 및 문의응대</p>
                      </div>

                      <div>
                        <h4 className="font-semibold mb-1 text-xs">3. 개인정보의 보유 및 이용기간</h4>
                        <p className="text-xs">회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다.</p>
                      </div>
                    </div>
                  ) : (
                    // 전체 개인정보처리방침
                    <>
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">1. 수집하는 개인정보 항목</h4>
                        <div className="space-y-1 md:space-y-2">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">2. 개인정보의 수집 및 이용목적</h4>
                        <div className="space-y-1 md:space-y-2">
                          <p>① 회원가입 및 관리</p>
                          <p>② 서비스 제공 및 운영</p>
                          <p>③ 고객상담 및 문의응대</p>
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">3. 개인정보의 보유 및 이용기간</h4>
                        <p>
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 md:mb-2">4. 개인정보의 파기절차 및 방법</h4>
                        <p>
